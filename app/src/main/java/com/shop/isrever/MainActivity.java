...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        redCount = (Button) findViewById(R.id.redCount);
        imageBlack = (ImageButton) findViewById(R.id.image_black);
        imageRed = (ImageButton) findViewById(R.id.image_red);
        createGrid();
        updateBoard();
        blackCount.setText(b_c+"");
        redCount.setText(w_c+"");
        if(blackTurn)
        {
            imageRed.setImageResource(R.drawable.tr);
        ...
        for(int i=0;i<8;i++)
        {
            for(int j=0;j<8;j++){
                ...
                if ((i == 3 && j == 3) || (i == 4 && j == 4)) {
                    ...
                    grid[i][j].setBlack(false);
                    grid[i][j].setImageResource(R.drawable.red);
                }
                if ((i == 4 && j == 3) || (i == 3 && j == 4)) {
                    grid[i][j].setClicked(true);
                ...
                if (blackTurn) {
                    ...
                    while (i < 8 && j < 8 && grid[i][j].getClicked()) {
                        ...
                        if (grid[i][j].getBlack())
                            valid = 1;
                        if (valid == 1 && !grid[i][j].getBlack()) {
                            Log.d("Red-Turn", " Diagonal Right Down" + " " + olc + " " + ilc + "");
                            flag = true;
                            break;
                        }
                        i++;
                    ...
                    while (i >= 0 && j >= 0 && !flag && grid[i][j].getClicked()) {
                        ...
                        if (grid[i][j].getBlack())
                            valid = 1;
                        if (valid == 1 && !grid[i][j].getBlack()) {
                            Log.d("Red-Turn", " Up Left" + " " + olc + " " + ilc + "");
                            flag = true;
                            break;
                        }
                        i--;
                    ...
                    while (i >= 0 && j < 8 && !flag && grid[i][j].getClicked()) {
                        ...
                        if (grid[i][j].getBlack())
                            valid = 1;
                        if (valid == 1 && !grid[i][j].getBlack()) {
                            Log.d("Red-Turn", " Diagonal Up Right" + " " + olc + " " + ilc + "");
                            flag = true;
                            break;
                        }
                        i--;
                    ...
                    while (i < 8 && j >= 0 && !flag && grid[i][j].getClicked()) {
                        ...
                        if (grid[i][j].getBlack())
                            valid = 1;
                        if (valid == 1 && !grid[i][j].getBlack()) {
                            Log.d("Red-Turn", " Diagonal Left Down" + " " + olc + " " + ilc + "");
                            flag = true;
                            break;
                        }
                        i++;
    ...
    public void onClick(View view) {
        ...
        if(blackTurn){
            ...
            checkRed(button.getAtX(),button.getAtY());
        button.setClicked(true);
        blackCount.setText(b_c+"");
        redCount.setText(w_c+"");
        blackTurn = !blackTurn;
        ...
        if (counter == 0) {
            ...
            if (counter == 0)
            {
                gameOver = true;
                if(b_c<w_c)
                    Toast.makeText(this, "!!!黒の勝ち!!!", Toast.LENGTH_SHORT).show();
                else if(w_c<b_c)
                    Toast.makeText(this, "!!!赤の勝ちー!!!", Toast.LENGTH_SHORT).show();
                else
    ...
    /*******************************************************************/
    public void checkRed(int row, int col){
        int i,j,count;
        //UP
        i = row-1;
        j = col;
        ...
        while(count>0)
        {
            grid[row-count][col].setImageResource(R.drawable.red);
        ...
        while(count>0)
        {
            grid[row][col-count].setImageResource(R.drawable.red);
        ...
        while(count>0)
        {
            grid[row-count][col+count].setImageResource(R.drawable.red);
